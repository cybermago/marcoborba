...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, CommonModule, FooterComponent, AboutComponent, ContactComponent, ServicesComponent, PricesComponent, CallActionComponent, TestimonialsComponent, GalleryComponent, HeaderComponent],
